...
import { Coins, Zap, Users, Trophy, ShoppingBag, CreditCard, Lock, AlertCircle, Gamepad } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-orange-500 to-red-600">
      <div className="container mx-auto p-4">
        ...
        <Tabs defaultValue="game" className="w-full">
          ...
          <Link
            href={"/games"}
            className="text-white/90 hover:bg-white/20 transition rounded-md px-3 py-2 flex items-center justify-center"
          >
            <span className="mr-1"> <Gamepad/> </span> Games
          </Link>
